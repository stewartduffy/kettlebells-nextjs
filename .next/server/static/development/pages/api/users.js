...
const cheerio = __webpack_require__(/*! cheerio */ "cheerio"); // const ejs = require("ejs");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  try {
    const data = await Promise.all(sitesToCheck.map(getHtml)); // console.log(data);
    // const template =
...
module.exports = __webpack_require__(/*! /Users/stewartduffy/repos/personal/kettlebells-nextjs/api-routes-middleware/pages/api/users.js */"./pages/api/users.js");
